...
extern int32    vid_hbl;
extern uint32   vid_baseh, vid_basem;
extern uint8    vid_syncmode, vid_shiftmode;
extern uint16   vid_colr[16*200];
extern uint16   vid_colf[200];
extern uint16   vid_col[16];
extern uint16   vid_flag;
extern int16    vid_rasters;

#define VIDFLAG_PALETTE     1
#define VIDFLAG_ADDRESS     2
#define VIDFLAG_REZ         4
...
#define PSGMODE_EMULATED    0
#define PSGMODE_DIRECT      1
#define PSGMODE_XBIOS       2

extern uint8    psgmode;

extern uint8    psgcontrol;
extern uint8	psg[16];
extern uint8    sample[64*1024];

extern uint32   phase0,phase1,phase2,phase3,phase4;
extern uint32   psg_epos, nrand, sampos;
...
extern void		IkbdJoystickEvent(unsigned char idx, int joystate);
...
extern int		HDC_Init(char *filename);
extern void     FDCCommand(void);
extern void		HDC_WriteCommandPacket(unsigned short value);
